...
typeTests =
    testGroup "Type assignment"
        ...
        , badType "test/err/merge.kmp" "Type a_4 -- Int a_4 is not as general as type a_3 -- a_3 a_3"
        ...
        , badType "test/err/typecheck.kmp" "Type a_8 -- a_8 a_8 is not as general as type a_5 b_6 -- a_5 b_6 c_7"
